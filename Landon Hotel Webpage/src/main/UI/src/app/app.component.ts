...
export class AppComponent implements OnInit{
 ...
 //     this.rooms=ROOMS;
    ...
    this.getMsges().subscribe(

      msgs => {console.log(Object.values(msgs));this.msges=msgs;}
    )
      this.getTimes().subscribe(
        times => {console.log(Object.values(times));this.presentationTimes=times;}
      )
